...
I initially wrote the code in Matlab and I've given it my best shot in Python, though it doesn't appear to be working properly. Would love some help on getting it right.
